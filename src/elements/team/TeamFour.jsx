    ...
    <div className="chy-team-4-area pt-130 pb-100">
      <div className="container chy-contaienr-2">
        ...
        <div className="section-title-wrap mb-20">
          <div className="left">
            <h5 className="chy-subtitle-4 chy-class-add">our best team members</h5>
            <h2 className="chy-title-4 chy-split-in-right chy-split-text">
              <SplitText text="Meet Our Professional Team Members" />
            </h2>
          </div>
          <div className="right">
              ...
              >
                <div className="main-img">
                  ...
                  <div className="content-wrap text-center">
                    <Link to="/team-details" className="chy-haeding-1 name">{item.name}</Link>
