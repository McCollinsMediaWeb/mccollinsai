...
function PricingTwo() {
  ...
  const data = [
    {
      ...
      list: [
        {
          name: "support at $25/hour"
        },
        {
          name: "small social media package"
        },
        {
          name: "unlimited fonts",
        },
      ],
  ...
  return (
    <div className="chy-price-2-area pt-170 pb-130 fix">
      ...
      <div className="section-title-wrap mb-35 text-center">
        ...
        <h2 className="chy-title-2 chy-split-in-right-2 chy-split-text">
          <SplitText2 text="find your right pland" />
        </h2>
      </div>
                    ...
                    <div className="content-wrap">
                      <div className="list-wrap">
                        <div className="price-wrap">
                          <h3 className="chy-heading-1 title">unlimited plan</h3>
                          <h4 className="chy-heading-1 price">
                            <span className="dollar-sine">us$</span>{item.price}
                      ...
                      <Link to="/contact-us" className="price-2-btn">
                        purchase now
                      </Link>
                    </div>
                  </div>
